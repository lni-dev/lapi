...
public interface CDNImage extends HasLApi {
     ...
     * {@link me.linusdev.discordbotapi.api.objects.sticker.StickerFormatType#PNG PNG} or
     * {@link me.linusdev.discordbotapi.api.objects.sticker.StickerFormatType#APNG APNG}.<br>
     * fileType must be {@link FileType#LOTTIE LOTTIE} if {@link Sticker#getFormatType() format_type} is
     * {@link me.linusdev.discordbotapi.api.objects.sticker.StickerFormatType#LOTTIE LOTTIE}.<br>
     *
     * @param lApi {@link LApi}
