...
public class UpdatableGuild extends Guild implements Datable, HasLApi, SnowflakeAble, Updatable {
    ...
    public UpdatableGuild(@NotNull LApi lApi, @NotNull Snowflake id, @NotNull String name, @Nullable Icon icon, @Nullable Icon iconHash, @Nullable Splash splash, @Nullable Splash discoverySplash, @Nullable Boolean owner, @NotNull Snowflake ownerId, @Nullable String permissions, @Nullable VoiceRegion region, @Nullable Snowflake afkChannelId, int afkTimeout, @Nullable Boolean widgetEnabled, @Nullable Snowflake widgetChannelId, @NotNull VerificationLevel verificationLevel, @NotNull DefaultMessageNotificationLevel defaultMessageNotifications, @NotNull ExplicitContentFilterLevel explicitContentFilter, @NotNull Role[] roles, @NotNull EmojiObject[] emojis, @Nullable String[] features, @NotNull MFALevel mfaLevel, @Nullable Snowflake applicationId, @NotNull Snowflake systemChannelId, int systemChannelFlagsAsInt, @NotNull SystemChannelFlag[] systemChannelFlags, @Nullable Snowflake rulesChannelId, @Nullable Integer maxPresences, @Nullable Integer maxMembers, @Nullable String vanityUrlCode, @Nullable String description, @Nullable Banner banner, @Nullable PremiumTier premiumTier, @Nullable Integer premiumSubscriptionCount, @NotNull String preferredLocale, @Nullable Snowflake publicUpdatesChannelId, @Nullable Integer maxVideoChannelUsers, @Nullable Integer approximateMemberCount, @Nullable Integer approximatePresenceCount, @Nullable WelcomeScreen welcomeScreen, @NotNull GuildNsfwLevel nsfwLevel, @Nullable Sticker[] stickers, @Nullable ISO8601Timestamp joinedAt, @Nullable Boolean large, @Nullable Boolean unavailable, @Nullable Integer memberCount, @Nullable VoiceStatesManager voiceStatesManager, @Nullable MembersManager membersManager, @Nullable ChannelsManager channelsManager, @Nullable ThreadsManager threadsManager, @Nullable PresencesManager presencesManager, @Nullable StageInstance[] stageInstances, @NotNull GuildScheduledEvent[] guildScheduledEvents) {
        super(lApi, id, name, icon, iconHash, splash, discoverySplash, owner, ownerId, permissions, region, afkChannelId, afkTimeout, widgetEnabled, widgetChannelId, verificationLevel, defaultMessageNotifications, explicitContentFilter, roles, emojis, features, mfaLevel, applicationId, systemChannelId, systemChannelFlagsAsInt, systemChannelFlags, rulesChannelId, maxPresences, maxMembers, vanityUrlCode, description, banner, premiumTier, premiumSubscriptionCount, preferredLocale, publicUpdatesChannelId, maxVideoChannelUsers, approximateMemberCount, approximatePresenceCount, welcomeScreen, nsfwLevel, stickers);
