...
public class IntegrationApplication implements Datable, HasLApi, SnowflakeAble {
     ...
     * @param fileType see {@link CDNImage#ofApplicationIcon(LApi, String, String, AbstractFileType) restrictions} and {@link me.linusdev.discordbotapi.api.communication.file.types.FileType FileType}
