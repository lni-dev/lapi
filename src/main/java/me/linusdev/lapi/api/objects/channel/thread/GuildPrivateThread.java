...
public class GuildPrivateThread extends Channel<GuildPrivateThread> implements Thread<GuildPrivateThread>, GuildChannel {
    ...
    public GuildPrivateThread(@NotNull LApi lApi, @NotNull Snowflake id, @NotNull ChannelType type, @NotNull SOData data) throws InvalidDataException {
    ...
    @Override
    public @NotNull GuildPrivateThread copy() {
        return new GuildPrivateThread(lApi,
                Copyable.copy(id),
                type,
                Copyable.copy(name),
