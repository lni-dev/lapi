...
/**
 * @see <a href="https://discord.com/developers/docs/resources/channel#embed-object-embed-video-structure" target="_top">Embed Image Structure</a>
 */
public class Video implements Datable {
     ...
     */
    public Video(@NotNull String url, @Nullable String proxyUrl, @Nullable Integer height, @Nullable Integer width){
        this.url = url;
     ...
     * @param width width of image
     */
    public Video(@NotNull String url, int height, int width){
     ...
     */
    public static @Nullable Video fromData(@Nullable SOData data) throws InvalidDataException {
        if(data == null) return null;
        String url = (String) data.get(URL_KEY);

        if(url == null){
            throw new InvalidDataException(data, "url may not be null in " + Video.class.getSimpleName()).addMissingFields(URL_KEY);
        }
        ...
        return new Video(url, proxyUrl, height == null ? null : height.intValue(), width == null ? null : width.intValue());
    }
    ...
    /**
     * Creates a {@link SOData} from this {@link Video}, useful to convert it to JSON
     */
    @Override
