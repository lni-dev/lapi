...
public class EditChannelTemplate implements Template {
    ...
    private final @Nullable Collection<ChannelFlag> flags;
    private final @Nullable Integer defaultThreadRateLimitPerUser;

    public EditChannelTemplate(@Nullable String name, @Nullable ChannelType type, @Nullable String topic,
                           ...
                           @Nullable SortOrderType defaultSortOrder, @Nullable Collection<ChannelFlag> flags,
