...
public class ForumThreadMessageTemplate extends MessageTemplate implements Template {
     ...
     */
    public ForumThreadMessageTemplate(@Nullable String content, @Nullable Embed[] embeds, @Nullable AllowedMentions allowedMentions, @Nullable Component[] components, @Nullable String[] stickerIds, @Nullable Attachment[] attachments, @Nullable Long flags) {
        super(content, null, null, embeds, allowedMentions, null, components, stickerIds, attachments, flags);
    }
}
